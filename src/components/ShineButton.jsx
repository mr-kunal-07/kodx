...
export default function ShineButton({
    ...
    showIcon = true,
    variant = "default" // "default", "clean" (no shine effect)
}) {
    return (
        <Link
            href={href}
            className="group relative w-fit flex items-center gap-2 text-white px-6 py-3 rounded-full border border-purple-400/50
