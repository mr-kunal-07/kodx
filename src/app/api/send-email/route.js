...
export async function POST(req) {
  try {
    ...
    const adminMailOptions = {
      from: `"KodX Media - Portfolio Contact" <${process.env.GMAIL_USER}>`,
      to: process.env.GMAIL_USER,
      subject: `📩 New Contact Form Submission - ${name}`,
      html: `
    <div style="font-family: Arial, sans-serif; background: linear-gradient(135deg, #AA14F0, #050012); padding: 20px; border-radius: 10px; color: white; max-width: 600px; margin: auto;">
      <h2 style="margin-top: 0;">📢 New Inquiry Received</h2>
      <p style="font-size: 14px; color: #e0e0e0;">A new contact form has been submitted on your portfolio website.</p>
  ...
  `,
    ...
    <div style="font-family: Arial, sans-serif; background-color: #f4f6f8; padding: 20px; border-radius: 10px; max-width: 600px; margin: auto; border: 1px solid #ddd;">
        ...
        <!-- Header -->
        <div style="text-align: center; padding-bottom: 10px; border-bottom: 2px solid #ff6600;">
            <h1 style="margin: 0; font-size: 28px; background: linear-gradient(90deg, #AA14F0, #050012); -webkit-background-clip: text; color: transparent; -webkit-text-fill-color: transparent;">
                KodX Media
            </h1>
            <p style="margin: 5px 0; color: #555;">Where Creativity Meets Technology</p>
        </div>
        
        <!-- Greeting -->
        <h2 style="margin-top: 20px; font-size: 20px; background: linear-gradient(90deg, #AA14F0, #050012); -webkit-background-clip: text; color: transparent; -webkit-text-fill-color: transparent;">
            Hello ${name},
        </h2>
        <p style="color: #333; font-size: 15px;">
            Thank you for reaching out to <strong style="background: linear-gradient(90deg, #AA14F0, #050012); -webkit-background-clip: text; color: transparent; -webkit-text-fill-color: transparent;">KodX Media</strong>! 
        ...
        <div style="background-color: #fff; padding: 15px; border-radius: 8px; border: 1px solid #eee; margin-top: 15px;">
            <h3 style="margin-top: 0; font-size: 18px; background: linear-gradient(90deg, #AA14F0, #050012); -webkit-background-clip: text; color: transparent; -webkit-text-fill-color: transparent;">
